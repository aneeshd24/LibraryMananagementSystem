...
public class Admin extends JFrame implements ActionListener{
    ...
    private String timeZone;
        public Admin() {
            ...
            ImageIcon iconLogoMain  = new ImageIcon(ClassLoader.getSystemResource("icons/admin.png"));
            ...
            menuBar.setBackground(new Color(78, 205, 196));
            menuBar.setBounds(0, 10, 1000, 35);
            contentPane.add(menuBar);

            JMenu mnExit = new JMenu("Exit");            
            mnExit.setForeground(Color.WHITE);
            mnExit.setFont(new Font("Monospace", Font.BOLD, 17));
            ...
            l1.setForeground(new Color(34, 166, 179));
            l1.setFont(new Font("Monospace",Font.BOLD,24));
            l1.setBounds(232, 45, 701, 80);
            contentPane.add(l1);
            ...
            b3.setBackground(new Color(34, 166, 179));
            ...
            panel.setBorder(new TitledBorder(new LineBorder(new Color(78, 205, 196), 2), "Operation", TitledBorder.LEADING,
            ...
            b4.setBackground(new Color(34, 166, 179));
            b4.setForeground(Color.WHITE);
            b4.setBounds(76, 620, 143, 41);
            b4.setFont(new Font("Monospace",Font.BOLD,14));
            contentPane.add(b4);

            b5 = new JButton("Remove Librarian");
            b5.addActionListener(this);
            b5.setBackground(new Color(34, 166, 179));
            b5.setForeground(Color.WHITE);
            b5.setBounds(310, 620, 159, 41);
            b5.setFont(new Font("Monospace",Font.BOLD,14));
            contentPane.add(b5);

            b6 = new JButton("About Us");
            b6.addActionListener(this);
            b6.setBackground(new Color(34, 166, 179));
            b6.setForeground(Color.WHITE);
            b6.setBounds(562, 620, 159, 41);
            b6.setFont(new Font("Monospace",Font.BOLD,14));
            contentPane.add(b6);

            JLabel l5 = new JLabel("");
            ImageIcon i10  = new ImageIcon(ClassLoader.getSystemResource("icons/statistics.png"));
            ...
            ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("icons/delete_lib.png"));
            ...
            ImageIcon i16  = new ImageIcon(ClassLoader.getSystemResource("icons/aboutUs.png"));
            ...
            panel2.setBorder(new TitledBorder(new LineBorder(new Color(78, 205, 196), 2), "Action", TitledBorder.LEADING,
        ...
        public Admin(String timeZone)
        {
            ...
            JLabel label=new JLabel(dateTime);
