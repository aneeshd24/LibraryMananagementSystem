...
public class IssueBook extends JFrame implements ActionListener{
	...
	ImageIcon iconLogoMain  = new ImageIcon(ClassLoader.getSystemResource("icons/student.png"));
	...
	t5.setFont(new Font("Monospace", Font.BOLD, 14));
	t5.setColumns(10);
	...
	t6.setFont(new Font("Monospace", Font.BOLD, 14));
	t6.setColumns(10);
	...
	t7.setFont(new Font("Monospace", Font.BOLD, 14));
	t7.setColumns(10);
	...
	t9.setFont(new Font("Monospace", Font.BOLD, 14));
	...
	t10.setFont(new Font("Monospace", Font.BOLD, 14));
	...
	t11.setFont(new Font("Monospace", Font.BOLD, 14));
	...
	t12.setFont(new Font("Monospace", Font.BOLD, 14));
	...
	t13.setFont(new Font("Monospace", Font.BOLD, 14));
	...
	t14.setFont(new Font("Monospace", Font.BOLD, 14));
	...
	panel_1.setBorder(new TitledBorder(new LineBorder(new Color(78, 205, 196), 2, true), "Student-Deatails",
    ...
    public boolean checkValid()
    {
        ...
        if(t1.getText().equals("") && t8.getText().equals("") && t2.getText().equals("") && t9.getText().equals("") && date.equals(""))
        {
            JOptionPane.showMessageDialog(null, "No Book can be issued without Book and Student..!");
            return false;
        }
        ...
        if(t8.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Student ID must be entered..!");
            return false;
        }
        ...
        if(t9.getText().equals("")){
          JOptionPane.showMessageDialog(null, "Student Name must be entered..!");
          return false;
        }
