...
public class ReturnBook extends JFrame implements ActionListener{
	...
	dateChooser.setBounds(167, 234, 172, 29);
        dateChooser.setDateFormatString("mm/dd/yyyx");
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(78, 205, 196), 2, true), "Return-Book",
			TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 184, 148)));
    ...
    public int checkReturnDate()
    {
        SimpleDateFormat dateFormat=new SimpleDateFormat();
        LocalDate d1 = LocalDate.parse(textField_6.getText(), DateTimeFormatter.ISO_LOCAL_DATE);
        LocalDate d2 = LocalDate.parse(dateChooser.getDateFormatString(), DateTimeFormatter.ISO_LOCAL_DATE);
        int days=new Calculator().calculateFine(d1, d2);
        return days;
    }
}
